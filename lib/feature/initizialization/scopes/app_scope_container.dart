...
class AppScopeContainer extends ScopeContainer {
  ...
  late final routerConfigDep = dep<AppRouter>(() => AppRouter(
      initialLocation: authRepositoryDep.get.getSignedInUser() == null ? AuthRoutes.login.path : HomeRoutes.home.path));
}
